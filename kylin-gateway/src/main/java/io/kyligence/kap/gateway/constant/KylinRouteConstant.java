...
public class KylinRouteConstant {

	private KylinRouteConstant() {
	...
	public static final String PREDICATE_ARG_KEY_2 = "_genkey_2";

	public static final String ASYNC_QUERY_SUFFIX = "/api/async_query";
